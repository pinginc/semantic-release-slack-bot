...
describe('test template', () => {
  ...
  it('should replace multiple variables in object', () => {
    ...
    const home = 'back';
    const expected = { hello: `${world}, welcome ${home}` };
    const actual = template({ hello: '$world, welcome $home' }, { home, world });
    assert.deepEqual(expected, actual);
  });
  ...
  it('should replace variables only if present', () => {
    ...
    const actual = template({ dimension: `${noVariables}`, hello: '$world, welcome $home' }, { home, world });
    assert.deepEqual(expected, actual);
  });
  ...
  it('should replace variables in all entries', () => {
    ...
    const actual = template({ hello: '$world', own: '$nothing' }, { nothing, world });
    assert.deepEqual(expected, actual);
  });
